...
export const Timeline = ({ data }) => {
  ...
  return (
    <div className="w-full font-sans" ref={containerRef}>
      <div className="max-w-8xl mx-auto py-10 px-4 md:px-8 lg:px-10">
        <h3 className="text-lg md:text-3xl mb-4 text-white max-w-4xl">
          Journey Timeline
        </h3>
        A timeline showcasing my professional growth, projects, and achievements
        over the years.
      </div>
