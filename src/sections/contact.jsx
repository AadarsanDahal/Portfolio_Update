...
const Contact = () => {
  return (
    <section
      className="py-20 px-6 md:px-8 lg:px-12 min-h-screen flex items-center"
      id="contact"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <div className="space-y-6">
              {/* LinkedIn */}
              <motion.a
                href="https://www.linkedin.com/in/aadarsan-dahal-8b7078299/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-4 p-3 rounded-lg bg-gray-800/30 hover:bg-blue-600/20 transition-all duration-300 group"
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-4 p-3 rounded-lg bg-gray-800/30 hover:bg-gray-600/20 transition-all duration-300 group"
                whileHover={{ scale: 1.02 }}
              >
              ...
              {/* Instagram */}
              <motion.a
                href="https://www.instagram.com/arsandahal/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-4 p-3 rounded-lg bg-gray-800/30 hover:bg-pink-600/20 transition-all duration-300 group"
                whileHover={{ scale: 1.02 }}
              >
                ...
                <div>
                  <h4 className="text-white font-medium group-hover:text-pink-300 transition-colors">
                    Instagram
                  </h4>
                  <p className="text-gray-400 text-sm">Visual updates</p>
                </div>
              </motion.a>

              {/* X (Twitter) */}
              <motion.a
                href="https://x.com/AadarsanD"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-4 p-3 rounded-lg bg-gray-800/30 hover:bg-purple-600/20 transition-all duration-300 group"
                whileHover={{ scale: 1.02 }}
              >
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Thoughts & updates</p>
                </div>
              </motion.a>
            </div>
          </motion.div>
